...
start /wait "" "%TEMP%\postgresql-9.4.26.exe" --mode unattended --superpassword "123456" --servicename "PostgreSQL" --servicepassword "123456" --serverport 5432
...
powershell -Command "Invoke-WebRequest -Uri 'https://onboardcloud.dl.sourceforge.net/project/xampp/XAMPP%20Windows/7.4.29/xampp-windows-x64-7.4.29-0-VC15-installer.exe?viasf=1' -OutFile '%TEMP%\xampp-installer.exe'"
