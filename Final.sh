...
echo.
echo [1/7] Menginstall PostgreSQL 9.4.26.1...
...
echo.
echo [2/7] Menginstall XAMPP 7.4.30-1...
...
echo.
echo [3/7] Menginstall Navicat Premium 16...
...
:: Install WinRAR 7.13
echo.
echo [4/7] Menginstall WinRAR 7.13...
...
echo.
echo [5/7] Menginstall Notepad++ 7.8.5...
...
echo.
echo [6/7] Menginstall .NET Framework 4.8...
...
echo.
echo [7/7] Menginstall Google Drive...
...
# Urutan download sesuai permintaan
echo "[1/10] Mengunduh DeepFreeze (hanya download)..."
download_with_retry "$DEEPFREEZE_URL" "DFStdServ.exe" &

echo "[2/10] Mengunduh Crack Navicat (hanya download)..."
...
echo "[5/10] Mengunduh Navicat Premium..."
