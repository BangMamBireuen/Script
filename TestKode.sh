...
if exist "C:\installers\xampp-installer.exe" (
    ...
    powershell -Command "& {
        ...
        \$process = Start-Process -FilePath 'C:\installers\xampp-installer.exe' -ArgumentList '--mode unattended', '--launchapps 0', '--enable-components servicedesigner' -Wait -PassThru
        if (\$process.ExitCode -eq 0) {
            ...
            \$process2 = Start-Process -FilePath 'C:\installers\xampp-installer.exe' -ArgumentList '/S' -Wait -PassThru
        }
    }"
