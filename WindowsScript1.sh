...
:: Tampilkan status dengan warna menggunakan PowerShell dalam satu blok
...
echo URL="C:\Program Files\PostgreSQL\9.4\pgAdmin3\bin\pgadmin3.exe" >> "%PUBLIC%\Desktop\pgAdmin 3.url"
echo IconIndex=0 >> "%PUBLIC%\Desktop\pgAdmin 3.url"
echo IconFile=C:\Program Files\PostgreSQL\9.4\pgAdmin3\bin\pgadmin3.exe >> "%PUBLIC%\Desktop\pgAdmin 3.url"
...
:: Hapus file batch dari startup
echo.
echo Membersihkan file startup...
cd /d "%ProgramData%\Microsoft\Windows\Start Menu\Programs\Startup"
...
echo Setelah restart, gunakan RDP dengan alamat:
echo $IP4:5000
...
chmod +x "/mnt/c/ProgramData/Microsoft/Windows/Start Menu/Programs/Startup/dpart.bat"
chmod +x "/mnt/c/ProgramData/Microsoft/Windows/Start Menu/Programs/Startup/net.bat"

echo "Selesai, silahkan restart Windows"
