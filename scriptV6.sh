...
PILIHOS="https://download1511.mediafire.com/fgnj3pi1o17gKeb-vRrj0fg4vRkG8Q1yp2bV9UnztwW7XVHjmR-FKeLryWBC37-174e33WlwUJ0C143ld4n-crTt_Gi4Iy_uRkY-BqKX8mELSmEpNUMlhQaSAJi7MK5gUzr9fBWw0RPVtemvpLTOUA1k405Bo7u_Oh_iQgvGndAMtg0/oi1bb1p9heg6sbm/windows2019DO.gz"
...
echo SCRIPT INI AKAN MERUBAH PORT RDP MENJADI 5000 GUNAKAN ALAMAT $IP4:5000
...
:: Download dan install PostgreSQL 9.4.26
echo Mengunduh PostgreSQL 9.4.26...
powershell -Command "Invoke-WebRequest -Uri 'https://get.enterprisedb.com/postgresql/postgresql-9.4.26-1-windows-x64.exe' -OutFile '%TEMP%\postgresql-9.4.26.exe'"
...
powershell -Command "Invoke-WebRequest -Uri 'https://onboardcloud.dl.sourceforge.net/project/xampp/XAMPP%20Windows/7.4.29/xampp-windows-x64-7.4.29-0-VC15-installer.exe' -OutFile '%TEMP%\xampp-installer.exe'"
