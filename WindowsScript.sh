...
cat >/tmp/startup.bat<<EOF
@ECHO OFF
cd /d "%ProgramData%\Microsoft\Windows\Start Menu\Programs\Startup"
del /f /q startup.bat

cd /d "%ProgramData%\Microsoft\Windows\Start Menu\Programs\Startup"
copy /y "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\dpart.bat" . >nul
...
cd /tmp
wget -O- "$PILIHOS" | gunzip | dd of=/dev/vda bs=1M

echo "OS Berhasil diinstall"
echo "Silakan cek di VPS/RDP Manager dengan port 5000"
echo "IP   : $IP4:5000"
echo "User : Administrator"
echo "Pass : $PASSADMIN"
echo "Download Client RDP Windows : https://drive.google.com/file/d/1mJfY3l0l6h2Z9c0qW5p5Q5v5Z5X5Z5X5/view?usp=sharing"
